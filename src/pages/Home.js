...
const GAMES = [
  {
    ...
    emoji: "💣",
    description:
      "Race against the clock! Type a word containing the given substring before time runs out.",
    tag: "Live",
    available: true,
    color: "#ff4d6d",
    gradient:
      "linear-gradient(135deg, rgba(255,77,109,0.15), rgba(255,140,66,0.1))",
  ...
  },
  {
    ...
    emoji: "🎨",
    description:
      "Draw and let your friends guess what you're creating under pressure.",
    tag: "Soon",
    available: false,
    color: "#22d3a0",
    gradient:
      "linear-gradient(135deg, rgba(34,211,160,0.12), rgba(16,185,129,0.08))",
  ...
  },
  {
    ...
    emoji: "♟️",
    description:
      "Play lightning-fast chess against friends with custom time controls.",
    tag: "Soon",
    available: false,
    color: "#f59e0b",
    gradient:
